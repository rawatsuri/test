"""
Test: Outbound Doctor Appointment Booking Call
Usage:
  python make_doctor_call.py +91XXXXXXXXXX [language]

Examples:
  python make_doctor_call.py +919053916964           # Hindi (default)
  python make_doctor_call.py +919053916964 en-IN     # English
"""
...
def make_doctor_call(to_number: str, language: str = "hi-IN"):
    ...
    print(f"📡 Creating doctor appointment pipeline session …")
    try:
...
<Response>
    ...
    print(f"🏥 Agent type: Doctor Appointment Booking")
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python make_doctor_call.py +91XXXXXXXXXX [language]")
        print("Examples:")
        print('  python make_doctor_call.py +919053916964          # Hindi')
        print('  python make_doctor_call.py +919053916964 en-IN    # English')
        sys.exit(1)

    to_number = sys.argv[1]
    language = sys.argv[2] if len(sys.argv) > 2 else "hi-IN"
    make_doctor_call(to_number, language)
