...
class SarvamTranscriberConfig(TranscriberConfig, type=TranscriberType.SARVAM.value):  # type: ignore
    """
    Sarvam AI transcriber config for Indian languages.
    
    Sarvam AI STT features:
    - Real-time WebSocket streaming: wss://api.sarvam.ai/speech-to-text/ws
