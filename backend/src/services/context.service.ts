...
/**
 * Context Service
 * Builds caller context and Pipecat pipeline configuration from database
 */
export class ContextService {
  ...
  async buildCallContext(
    tenantId: string,
    callerId: string,
  ): Promise<{ success: boolean; context?: PipecatContext; error?: string }> {
    try {
      // Get caller details
